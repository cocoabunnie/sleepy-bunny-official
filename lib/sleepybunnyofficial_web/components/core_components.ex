defmodule SleepybunnyofficialWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SleepybunnyofficialWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SleepybunnyofficialWeb.Gettext, "errors", msg, opts)
    end
  end
